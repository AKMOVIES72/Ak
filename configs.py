...
MULTI_CLIENT = False
name = str(environ.get('name', 'Akmovies'))
...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 26264369)
	API_HASH = os.environ.get("API_HASH", "cff042e35804f2a09fdd8d66542a4936")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","8056411748:AAFytNFEKPVmipbIyKrYeaQlAi88wc9ikBg")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "AkAutofilterv2_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002436581560))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "51179468118"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://aravindguru996:JrLXt0PhZ1YyW5o2@cluster0.n8rps.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002393589774")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002395485165")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "-1002395485165").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL','-100'))
	LAZY_MODE = bool(os.environ.get("LAZY_MODE", False))
	LAZY_PIC = os.environ.get("Ak_PIC","https://envs.sh/dYL.jpg")
